...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.createUser = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                user_services_1.default.create(req.body, function (error, results) {
                    if (error) {
                        return next(error);
                    }
    ...
    UsersController.prototype.login = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                user_services_1.default.login(req.body, function (error, results) {
                    if (error) {
                        return next(error);
                    }
                    return res.status(200).send({
    ...
    ;
    UsersController.prototype.patch = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // log(await usersService.patchById(req.body));
                user_services_1.default.patchById(req, function (error, results) {
                    if (error) {
                        return next(error);
                    }
                    return res.status(200).send({
    ...
    UsersController.prototype.put = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                user_services_1.default.updateById(req, function (error, results) {
                    if (error) {
                        return next(error);
                    }
                    return res.status(200).send({
    ...
    UsersController.prototype.removeUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_services_1.default.deleteById(req.params.userId)];
                    case 1:
                        result = _a.sent();
                        log(result);
