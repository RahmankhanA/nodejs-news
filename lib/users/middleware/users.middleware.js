        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (req.body && req.body.country) {
                    ...
                    res.status(400).send({ error: "Missing required fields: Country" });
                }
                return [2 /*return*/];
            });
        });
    };
    UsersMiddleware.prototype.validateSameEmailDoesNotExist = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (user) {
                            ...
                            res.status(404).send({ error: "User ".concat(req.params.userId, " not found") });
                        }
                        return [2 /*return*/];
                }
            });
